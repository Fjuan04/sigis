...
@auth
    ...
    @section('main-class', 'flex justify-center')
...
@section('content')
    ...
    <div class="rounded-lg shadow  mt-[80px]  ">
        
            <div class="join m-auto h-auto md:h-[41px] my-5 w-[90%] flex  flex-col md:flex-row items-center gap-2 md:gap-0 ">
                    <div class="md:w-full">
                        <input class="input join-item border border-gray-300 w-full" placeholder="Portatil Lenovo" />
                    </div>
                
                    <div class="buttons flex h-[41px] w-full">
                        <button class="btn join-item bg-sena-verde h-full px-5 text-white"><svg xmlns="http://www.w3.org/2000/svg" class="size-7" fill="#fff" viewBox="0 0 256 256"><path d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"></path></svg></button>

                    <button class="btn h-full bg-[#a7a7a7] flex h-full items-center join-item px-4 w-[100px] text-white text-sm">
      ...
      <table class="min-w-full text-left text-sm bg-white border mt-5 border-gray-200">
        <thead class="bg-gray-100 w-full text-gray-800 font-semibold">
          <tr class="">
        ...
        <tbody class="text-gray-700">
            ...
            @empty
                <tr class=""><td colspan="7" class="indent-5">No hay items registrados</td></tr>
            @endforelse
