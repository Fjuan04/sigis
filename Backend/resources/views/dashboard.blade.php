...
@section('content')
    ...
    <div class="overflow-x-auto rounded-lg shadow md:w-[90%] mt-[60px] ">
            ...
            <div class="join m-auto  my-5 w-[90%] flex  flex-col md:flex-row items-center  gap-2 md:gap-0 ">
                    <div class="md:w-full">
                        <input class="input join-item border border-gray-300 w-full" placeholder="Portatil Lenovo" />
                    </div>
                
                    <button class="btn join-item bg-sena-verde w-[40px] px-10 text-white">Buscar</button>

                    <button class="btn bg-[#a7a7a7] join-item px-4 w-[100px] text-white text-sm">
