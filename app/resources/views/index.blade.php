...
@section('content')
    ...
    <div class="min-h-screen flex items-center justify-center bg-sena-grisClaro font-sans">
        ...
        <div class="bg-white shadow-lg rounded-2xl flex max-w-3xl w-full overflow-hidden">
            
            <!-- Columna del logo -->
            <div class="w-1/2 bg-white flex items-center justify-center p-6 relative" >
            ...
            <img src="{{ asset('assets/logo-sena.jpeg') }}" alt="Logo SENA" class="w-32">
            </div>
            ...
            <a href="{{ route('password.request') }}" class="mt-4 text-sm text-sena-verde hover:underline">
